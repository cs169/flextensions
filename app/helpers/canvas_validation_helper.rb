module CanvasValidationHelper
  ...
  def is_valid_course_id(courseId)
    courseId.is_a?(Integer) && courseId.positive?
  end
  ...
  def is_valid_lms_id(lmsId)
    lmsId.is_a?(Integer) && lmsId.positive?
  end
  ...
  def is_valid_assignment_id(assignmentId)
    assignmentId.is_a?(Integer) && assignmentId.positive?
  end
  ...
  def is_valid_student_id(studentId)
    studentId.is_a?(Integer) && studentId.positive?
  end
