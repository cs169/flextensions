...
module Api
  module V1
    describe ExtensionsController, allow_net_connect: true do
      before do
      ...
      describe 'POST /api/v1/courses/:course_id/lmss/:lms_id/assignments/:assignment_id/extensions' do
        before(:all) do
          ...
          @mock_assignments_url = "#{ENV.fetch('CANVAS_URL',
                                               nil)}/api/v1/courses/#{@course_to_lms.external_course_id}/assignments"
