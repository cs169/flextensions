...
RSpec.describe 'Bcourses', type: :request do
  describe 'GET /index' do
    ...
    before do
      ...
      allow(Rails.application.credentials.canvas).to receive_messages(url: 'https://ucberkeley.test.instructure.com',
    ...
    context 'when token is expired' do
      ...
      before do
        allow(api_mock).to receive(:api_get_request).and_raise(LMS::Canvas::RefreshTokenRequired,
